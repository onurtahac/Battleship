...
{
    public class TwoPlayerGameAppService : ITwoPlayerGameService
    {
        ...
        private List<Coordinates> GetShipCoordinates(Ships ship, int length, bool isVertical)
        {
            ...
            for (int i = 0; i < length; i++)
            {
                if (isVertical)
                {
                    coordinates.Add(new Coordinates { Row = (char)(startRow + i), Col = startCol });
                }
                else
                {
                    coordinates.Add(new Coordinates { Row = (char)startRow, Col = startCol + i });
                }
            }
